...
async function main() {
if (!RPC_URL || !CHAIN_ID || !PRIVATE_KEY) throw new
Error("Missing env vars");
const { abi, bytecode } = await
artifacts.readArtifact("CampusCreditV2");
const chain = {id: CHAIN_ID,
...
abi, bytecode,
args: [NAME, SYMBOL, cap, getAddress(account.address),
initialMint],
